...
const solutions = [
  {
    name: "Iniciar Sesión",
    description: "Autentíquese y acceda a más funcionalidades",
    href: "/autenticar",
    icon: IconOne,
  },
  {
    name: "Materiales",
    description: "Ver materiales disponibles actualmente",
    href: "/materiales",
    icon: IconTwo,
  },
  {
    name: "Noticias",
    description: "Lo más importante en noticias UCI",
    href: "/noticias",
    icon: IconThree,
  },
  {
    name: "¿Quiénes somos?",
    description: "Descubre un poco más sobre el departamento",
    href: "/somos",
    icon: IconCuatro,
  },
  {
    name: "Contáctanos",
    description: "Comuníquese para más información",
    href: "/contacto",
    icon: IconCinco,
  },
  // {
      ...
      <div className=" px-4 sm:px-6  ">
        <div className="-ml-4 -mt-2 hidden lg:flex flex-wrap items-center justify-between sm:flex-nowrap md:px-13   px-2">
          ...
          <div className="ml-4 mt-2 flex-shrink-0">
            ...
            <Link
              to="/Autenticar"
              className="inline-flex ml-12 mr-8 items-center rounded-md border border-transparent transition duration-300 ease-in-out bg-blue-800 px-5  py-2  font-medium text-white shadow-sm hover:bg-indigo-950 focus:outline-none focus:ring-1 text-lg focus:ring-indigo-500 focus:ring-offset-2"
            >
              Iniciar Sesión
              <BeatLoader
                className="pl-2"
