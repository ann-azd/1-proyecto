    ...
    >
      <div className=" px-4 sm:px-6  ">
        <div className="-ml-4 -mt-2 hidden lg:flex flex-wrap items-center justify-between sm:flex-nowrap md:px-13   px-2">
          <Link to="/secretaria" className="ml-4 mt-1">
            <img
              src={logoM}
              alt=""
              width={280}
          ...
          <div className="ml-4 mt-2 flex items-center  flex-shrink-0">
            ...
            <Link
              onClick={logoutHandler}
              to="/"
              className="inline-flex ml-12 mr-8 items-center rounded-md border border-transparent transition duration-300 ease-in-out bg-green-700 px-5  py-2  font-medium text-white shadow-sm hover:bg-indigo-950 focus:outline-none focus:ring-1 text-lg focus:ring-indigo-500 focus:ring-offset-2"
            >
              Cerrar sesión
              <svg
