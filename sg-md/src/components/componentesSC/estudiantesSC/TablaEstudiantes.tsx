    ...
    <>
      <Card className="">
        <Title className="md:text-3xl text-xl text-center ">
          ...
          <Badge className="tremor-Badge-root w-max flex-shrink-0 inline-flex justify-center items-center cursor-default text-green-700 bg-green-100 rounded-full px-2.5 py-0.5 text-sm ml-3">
            {posts2.length}
          </Badge>
        </Title>
              ...
              >
                ...
                <TableCell
                  className={`min-w-20 max-w-20 overflow-auto font-bold text-lg ${
                    post.category.bandera ? "text-red-900" : "text-lime-700"
                  } `}
                >
