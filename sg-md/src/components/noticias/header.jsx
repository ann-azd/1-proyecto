import headerHome from "assets/header-noticias.png";
        ...
        <div className="mx-auto max-w-full xl:mx-12   sm:pt-6 lg:pt-26 xl:pt-28  pb-12   xl:pb-60 ">
          <div>
            <div>
              ...
              >
                <h1 className="text-2xl text-fuchsia-900 font-semibold tracking-tight pt-12  sm:text-3xl lg:text-6xl">
                  Noticias importantes
                  <p className="text-fuchsia-900  ">(FTE)</p>
                </h1>
